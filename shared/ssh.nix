...
let
  ...
  hostKeys = {
    ...
    ampere = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAINGhLq36PrTM1jHfMdTzrGt6fAeZwE1P5zT5H2l+EkPC";
  ...
  userKeys = {
    ...
    ampere = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIOENWmXEfXSE1H5trG+7UZp4eY+Xf8VpfMobS3F5tzIa andrei@ampere";
